        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed md:absolute top-24 md:top-20 md:right-4 md:left-auto inset-x-4 md:inset-x-auto md:translate-x-0 w-auto md:w-56 max-h-[calc(100vh-8rem)] md:max-h-auto bg-background border border-border rounded-lg shadow-xl z-50"
            >
            {/* User Info */}
